...
const bluDishes = {
  // Blue-Liv menu verified dishes. Names/sections/images/sourceTitle are copied from
  // /root/work/Blue-Liv/app/data.js so Pocket Wines never pairs a bottle to a non-menu dish.
  oysters: { id: 'oysters', name: 'Oysters', section: 'Jewels of the Sea', image: '/foods/oysters.jpg', sourceTitle: 'Oysters six pieces: beau soleil $25 | gold kumamoto $37 | east & west $30/$60 served with cava rose mignonette & tomato granita' },
  truffledTuna: { id: 'truffled-tuna', name: 'Truffled Tuna', section: 'Jewels of the Sea', image: '/foods/truffled-tuna.jpg', sourceTitle: 'Truffle Tuna ponzu, asian pear, hijiki' },
  redSnapperCeviche: { id: 'red-snapper-ceviche', name: 'Red Snapper Ceviche', section: 'Jewels of the Sea', image: '/foods/red-snapper-ceviche.jpg', sourceTitle: "Red Snapper Ceviche serrano, tiger's milk, lemon oil" },
  lobsterCocktail: { id: 'maine-lobster-cocktail', name: 'Maine Lobster Cocktail', section: 'Jewels of the Sea', image: '/foods/maine-lobster-cocktail.jpg', sourceTitle: 'Maine Lobster Cocktail avocado-yuzu aioli, orange dressing' },
  bluRoll: { id: 'the-blu-roll', name: 'The Blu Roll', section: 'Sushi Rolls', image: '/foods/the-blu-roll.jpg', sourceTitle: 'The Blu Roll blue fin toro, spicy lobster salad, avocado' },
  misoCod: { id: 'miso-black-cod', name: 'Miso Black Cod', section: 'Skewers', image: '/foods/miso-black-cod.jpg', sourceTitle: 'Skewer miso black cod' },
  porkBelly: { id: 'pork-belly-skewers', name: 'Pork Belly Skewers', section: 'Skewers', image: '/foods/pork-belly-skewers.jpg', sourceTitle: 'Skewer pork belly' },
  burrata: { id: 'burrata', name: 'Burrata', section: 'Blu Classics', image: '/foods/burrata.jpg', sourceTitle: 'Burrata eggplant caponata, basil, grilled focaccia' },
  carpaccio: { id: 'carpaccio', name: 'Carpaccio', section: 'Blu Classics', image: '/foods/carpaccio.jpg', sourceTitle: 'Carpaccio truffle-olive tapenade, basil aioli, potato crisps, pecorino' },
  bolognese: { id: 'bolognese', name: 'Bolognese', section: 'House-Made Pastas', image: '/foods/bolognese.jpg', sourceTitle: 'Bolognese rigatoni, wagyu & prime blend, pecorino' },
  gnocchi: { id: 'ricotta-gnocchi', name: 'Ricotta Gnocchi', section: 'House-Made Pastas', image: '/foods/ricotta-gnocchi.jpg', sourceTitle: 'Ricotta Gnocchi spicy vodka sauce' },
  lobsterFraDiavolo: { id: 'lobster-fra-diavolo', name: 'Lobster Fra Diavolo', section: 'House-Made Pastas', image: '/foods/lobster-fra-diavolo.jpg', sourceTitle: 'Lobster Fra Diavolo spaghetti, spicy tomato sauce, basil' },
  chickenParm: { id: 'organic-chicken-parm', name: 'Organic Chicken Parm', section: 'Land & Sea', image: '/foods/organic-chicken-parm.jpg', sourceTitle: 'Organic Chicken Parm spicy vodka sauce, mozzarella' },
  salmon: { id: 'faroe-islands-salmon', name: 'Faroe Islands Salmon', section: 'Land & Sea', image: '/foods/faroe-islands-salmon.jpg', sourceTitle: 'Faroe Island Salmon spring peas, asparagus, meyer lemon' },
  branzino: { id: 'branzino', name: 'Branzino', section: 'Land & Sea', image: '/foods/branzino.jpg', sourceTitle: 'Branzino chickpeas salad, salsa verde, tomatoes, tahini' },
  doverSole: { id: 'dover-sole', name: 'Dover Sole', section: 'Land & Sea', image: '/foods/dover-sole.jpg', sourceTitle: 'Dover Sole lemon brown butter sauce' },
  lamb: { id: 'australian-lamb', name: 'Australian Lamb', section: 'Land & Sea', image: '/foods/australian-lamb.jpg', sourceTitle: 'Australian Lamb labneh-tahini sauce, herbs, lemon' },
  skirtSteak: { id: 'westholme-wagyu-skirt-steak', name: 'Westholme Wagyu Skirt Steak', section: 'Steaks', image: '/foods/westholme-wagyu-skirt-steak.jpg', sourceTitle: 'Westholme Wagyu Skirt Steak 8oz, Queensland' },
  filet: { id: 'filet-mignon-steak', name: 'Filet Mignon', section: 'Steaks', image: '/foods/filet-mignon-steak.jpg', sourceTitle: 'Filet Mignon 8oz, NE' },
  delmonico: { id: 'delmonico-steak', name: 'Delmonico', section: 'Steaks', image: '/foods/delmonico-steak.jpg', sourceTitle: 'Delmonico 16oz - 20oz, CA' },
  porterhouse: { id: 'porterhouse-steak', name: 'Porterhouse', section: 'Steaks', image: '/foods/porterhouse-steak.jpg', sourceTitle: 'Porterhouse prime, 32oz, AI' },
  tomahawk: { id: 'prime-40oz-tomahawk-steak', name: 'Prime 40oz Tomahawk', section: 'Steaks', image: '/foods/prime-40oz-tomahawk-steak.jpg', sourceTitle: 'Prime Tomahawk, 40oz Queensland' },
  wagyuA5: { id: 'japanese-a5-wagyu-steak', name: 'Japanese A5 Wagyu', section: 'Steaks', image: '/foods/japanese-a5-wagyu-steak.jpg', sourceTitle: 'Japanese A5 Wagyu Miyazaki Prefecture' },
  carrotCake: { id: 'classic-carrot-cake', name: 'Classic Carrot Cake', section: 'Desserts', image: '/foods/classic-carrot-cake.jpg', sourceTitle: 'Carrot Cake cream cheese mousse, candied pecans butterscotch sauce (nut-free available on request)' },
  tiramisu: { id: 'blu-s-tiramisu', name: "Blu's Tiramisu", section: 'Desserts', image: '/foods/blu-s-tiramisu.jpg', sourceTitle: "Blu's Tiramisu house-made ladyfingers, mascarpone cream valrhona chocolate shavings" },
  granita: { id: 'granita', name: 'Granita', section: 'Desserts', image: '/foods/granita.jpg', sourceTitle: 'Granita cucumber-lime, fresh mint Add: Champagne Tellmont 12 Casamigos Reposado 19 Dos Artes Reposado 55' },
};
